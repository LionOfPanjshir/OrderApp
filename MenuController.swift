...
class MenuController {
    ...
    func fetchImage(from url: URL) async throws -> UIImage {
        ...
        guard let httpResponse = response as? HTTPURLResponse, httpResponse.statusCode == 200 else { throw MenuControllerError.photoNotFound }
        
        guard let image = UIImage(data: data) else { throw MenuControllerError.photoNotFound }
